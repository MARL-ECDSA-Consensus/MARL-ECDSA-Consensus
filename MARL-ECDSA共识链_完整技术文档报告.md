...
|------|------|---------|-------|
| AL-01 | P0 | 训练进程崩溃 | @张敏杰 |
| AL-02 | P0 | Dashboard无法访问 | @刘科 |
| AL-03 | P1 | 共识成功率 < 90% | @王家鑫 |
| AL-04 | P2 | ECDSA验证失败 > 0 | @黎成哲 |
| AL-05 | P2 | CPU > 95% 持续5分钟 | @张敏杰 |
| AL-06 | P3 | 训练奖励连续10回合无改善 | @张敏杰 |
...
| 角色 | 姓名 | 负责模块 |
|------|------|----------|
| MARL算法 | @张敏杰 | M4双向协同引擎, M8 MPE环境, M9 IQL算法 |
| 区块链共识 | @王家鑫 | M2 CW-PBFT共识, M3激励结算, M10分布式账本 |
| 密码学安全 | @黎成哲 | M1 ECDSA认证, M6 SecurityGuard |
| P2P网络 | @刘科 | M5 P2P网络, M7 Dashboard可视化 |
